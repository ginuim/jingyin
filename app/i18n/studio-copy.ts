...
const zh: StudioCopy = {
  ...
  hero: {
    eyebrow: "ON-DEVICE · NO UPLOAD",
    titleLine1: "想分享生活，",
    titleHighlight: "先把隐私藏好。",
    body: "家人的照片和视频、街拍里的路人、清晰人像与语音，都可能被保存、再传播。镜隐在设备本地完成遮盖与声音处理，不上传任何素材，适合分享前给家人、路人打码。",
    trustNoSignup: "无需注册",
    trustFree: "免费试用",
    trustLocal: "素材不出设备",
  },
  studio: {
    ariaLabel: "视频打码工作台",
    uploadTitle: "选择你的视频",
    uploadHint: "点击选择，或将文件拖到这里；只在本机打开",
    uploadButton: "选择视频",
  ...
  quality: {
    ...
    highSub: "逐帧",
    aria: "处理精度",
    preciseNoticeTitle: "网页高档 · 逐帧处理",
    preciseNoticeBodyReady: "已启用 YOLO：统一识别人、宠物与车辆，使用 WebGPU 逐帧生成独立轮廓。",
    preciseNoticeBodyBenchmarking: "模型已就绪，正在测速。",
    preciseEstimateDone: (time) => `本机预计约 ${time} 完成。`,
    preciseNoticeBodyIdle: "默认可直接用本机人物轮廓做逐帧处理；宠/车用框选。可选加载 YOLO（约 11MB）加强实例轮廓。",
    preciseReload: "重新加载 YOLO 模型",
    preciseConfirmLoad: "可选：加载 YOLO 增强",
    preciseEstimateWarning: "YOLO 本机预计超过 6 分钟，已停用该增强；可直接导出 BodyPix 逐帧，或改用标准档 / App。",
    blurStrength: "模糊强度",
  ...
  appUpsell: {
    kicker: "iOS APP",
    title: "照片批量与更稳的视频处理，用 iOS App",
    body: "原素材、识别结果和导出都在设备本地完成，不上传服务器。适合家人照片批量打码，以及路人、旁观者入镜后再分享。",
    button: "了解 iOS App",
  },
  privacyNote: {
    title: "纯本地处理，不上传任何数据",
    sub: "原素材、识别结果和导出都留在当前设备。",
  },
  export: {
  ...
  scenarios: {
    ...
    titleLine1: "想分享家人照片和视频，",
    titleLine2: "先在本地打好码。",
    intro: "照片和视频一旦公开，就可能被保存、裁剪和再次传播。家人合影、旅行街拍、孩子出镜——先遮住路人或不必公开的主体，素材全程留在本机，不上传任何数据。",
    localProofTitle: "纯本地 · 不上传",
    localProofSub: "识别、遮盖和导出都在当前设备完成",
    cards: [
      {
        title: "分享家人的照片与视频",
        body: "发布前隐藏孩子、家人或同伴的清晰人像，减少身份线索在未知渠道继续流传。",
        fit: "适合：遮盖主体",
      },
      {
        title: "给路人和旁观者打码",
      ...
      {
        title: "同时处理画面与声音",
        body: "高质量正脸和清晰语音都可能被复用。可模糊人物，并变音或静音后再分享。",
        fit: "适合：遮盖主体 + 声音处理",
      },
    ],
  },
  how: {
    ...
    title: "三步，保护每一帧。",
    steps: [
      { title: "选择素材", body: "从手机或电脑选择视频，文件只在本机打开，不会上传。" },
      { title: "设置隐私处理", body: "选择画面遮盖范围，并决定保留原声、变音或静音。" },
      { title: "导出结果", body: "在本机逐帧处理完成后，直接保存到设备。" },
    ],
  },
  banner: {
    label: "PRIVACY BY DESIGN",
    title: "你的素材，始终是你的。",
    body: "没有上传、没有云端副本、没有账号。处理全程在当前设备完成。",
  },
  footer: {
    tagline: "纯本地处理的视频与照片隐私工具",
    privacy: "隐私政策",
    reaidea: "reaidea.com",
  ...
  msg: {
    ...
    mobileHighDisabled: "为避免手机页面卡死和严重发热，YOLO 增强仅支持桌面 WebGPU；手机可用高档 BodyPix 逐帧，或改用标准档 / App",
    highModelSizeHint: "YOLO 增强约 11MB；桌面浏览器首次编译可能短暂停顿，请确认后再加载",
    highModeBodyPixHint: "高档已用本机人物轮廓逐帧处理，无需先加载 YOLO；宠/车仍为框选，需要实例轮廓时可再加载增强模型",
    highModelInitSoon: "即将初始化 YOLO WebGPU 模型；页面可能短暂停顿，请勿切换标签",
    appPlanMessage: "iOS App 已支持视频与照片本地打码（含照片批量）；网页端继续提供免费试用，适合快速处理短视频",
    highOnlyDesktop: "YOLO 增强需要桌面 WebGPU；手机请用高档 BodyPix、标准档或 App",
  },
};

const en: StudioCopy = {
  brand: "LensHide",
  documentTitle: "LensHide | On-device video & photo privacy",
  header: {
  ...
  hero: {
    ...
    body: "Family photos and videos, passersby in street shots, clear faces and voices—all can be saved and reshared. LensHide masks and adjusts audio entirely on your device. Nothing is uploaded. Built for sharing family moments and anonymizing bystanders first.",
    trustNoSignup: "No sign-up",
    trustFree: "Free to try",
    trustLocal: "Media never leaves your device",
  },
  studio: {
    ariaLabel: "Video privacy workspace",
    uploadTitle: "Choose your video",
    uploadHint: "Click to choose, or drop a file here—opens locally only",
    uploadButton: "Choose video",
    uploadFormats: "MP4 · MOV · WebM · ~500MB max",
    ...
    modelLoadingBase: "Loading base models…",
  ...
  quality: {
    ...
    balanced: "Person outlines",
    fast: "Fast boxes",
    low: "Fast",
    lowSub: "Box masks",
    mid: "Standard",
    midSub: "Person outlines",
    high: "High",
    highSub: "Frame-by-frame",
    aria: "Processing quality",
    preciseNoticeTitle: "High · frame-by-frame",
    preciseNoticeBodyReady: "YOLO enabled: people, pets, and vehicles get per-instance WebGPU outlines, frame by frame.",
    preciseNoticeBodyBenchmarking: "Model ready; benchmarking this device.",
    preciseEstimateDone: (time) => `About ${time} on this device.`,
    preciseNoticeBodyIdle: "Uses on-device person outlines frame by frame by default; pets/vehicles stay boxes. Optionally load YOLO (~11MB) for instance masks.",
    preciseReload: "Reload YOLO model",
    preciseConfirmLoad: "Optional: load YOLO boost",
    preciseEstimateWarning: "YOLO estimated over 6 minutes; boost disabled. You can still export BodyPix frame-by-frame, or use medium / the app.",
  ...
  appUpsell: {
    kicker: "iOS APP",
    title: "Batch photos and steadier video on the iOS app",
    body: "Original media, detections, and exports stay on device—nothing uploaded. Built for family photo batches and masking passersby before you share.",
    button: "About the iOS app",
  },
  privacyNote: {
    title: "On-device only. Nothing uploaded.",
    sub: "Source media, detections, and exports stay on this device.",
  },
  export: {
    ...
    confirmHighModel: "Load high model",
    slowMachine: "Slow device · use app",
    startPrecise: "Export (HQ)",
    startFast: "Export (fast)",
  },
  scenarios: {
    label: "BEFORE YOU SHARE",
    titleLine1: "Sharing family photos & videos?",
    titleLine2: "Mask them on-device first.",
    intro: "Once media is public, it can be saved, cropped, and reshared. Family shots, travel clips, kids on camera—hide passersby or anyone who should stay private. Everything stays on this device. Nothing uploaded.",
    localProofTitle: "On-device · No upload",
    localProofSub: "Detection, masking, and export stay on this device",
    cards: [
      {
        title: "Share family photos & videos",
        body: "Hide clear faces of kids, relatives, or friends before posting so identity cues do not keep spreading.",
        fit: "Best for: mask subjects",
      },
      {
        title: "Blur passersby and bystanders",
        body: "Parties, trips, and street shots catch strangers. Anonymize anyone who did not agree to be public.",
      ...
      {
        title: "Cover video and audio together",
        body: "Sharp faces and clean voices are reusable. Blur people and shift or mute audio before you share.",
  ...
  how: {
    ...
    steps: [
      { title: "Choose media", body: "Pick a file from phone or computer—it opens locally. Nothing is uploaded." },
      { title: "Set privacy", body: "Choose what to mask on screen and whether to keep, shift, or mute audio." },
      { title: "Export", body: "Processing runs on this device, then you save the result locally." },
    ],
  },
  banner: {
    label: "PRIVACY BY DESIGN",
    title: "Your media stays yours.",
    body: "No upload, no cloud copy, no account. Everything finishes on the current device.",
  },
  footer: {
    tagline: "On-device video & photo privacy",
    privacy: "Privacy",
    reaidea: "reaidea.com",
  ...
  msg: {
    ...
    aiLoading: "Loading AI (first visit may download models)…",
    ...
    videoOpened: "Opened locally—pick a mask mode",
    ...
    mobileHighDisabled: "YOLO boost is desktop WebGPU only. On phone, use High with BodyPix, medium, or the app.",
    highModelSizeHint: "YOLO boost is ~11MB; first WebGPU compile may pause briefly—confirm to load.",
    highModeBodyPixHint: "High mode uses on-device person outlines frame by frame—no YOLO required. Pets/vehicles stay boxes; load the boost for instance masks.",
    highModelInitSoon: "About to init YOLO WebGPU model; the page may pause briefly.",
    appPlanMessage: "The iOS app supports on-device video and photo masking (including photo batches). The web tool stays free for quick short clips.",
    highOnlyDesktop: "YOLO boost needs desktop WebGPU. On phone, use High with BodyPix, medium, or the app.",
  },
};
