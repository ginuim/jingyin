    ...
    <div className="policy-shell">
      ...
      <main className="policy-main">
        ...
        <aside className="policy-summary">
          ...
          <p>视频读取、识别、遮盖、声音处理和导出均在当前设备上完成。镜隐不提供云端视频存储，也不要求创建账号。</p>
        </aside>
        ...
        <div className="policy-content policy-en" lang="en">
          <section>
            ...
            <p>LensHide processes imported videos, detections, masks, audio changes, and exports locally on your device. We do not upload your video to LensHide servers, provide cloud video storage, or require an account.</p>
