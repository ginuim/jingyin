...
export const metadata: Metadata = {
  ...
  description: "镜隐 LensHide iOS App 与网页工具的隐私政策。",
    ...
    <div className="policy-shell">
      ...
      <main className="policy-main">
        ...
        <aside className="policy-summary">
          <strong>最重要的一点：你的视频不会上传给镜隐。</strong>
          <p>视频读取、识别、遮盖、声音处理和导出均在当前设备上完成。镜隐不提供云端视频存储，也不要求创建账号；我们也不会查看或审核你设备上的视频。</p>
        </aside>
        ...
        <div className="policy-content">
          <section>
            ...
            <ul>
              <li>只有在你主动从照片图库或“文件”中选择视频后，App 才会读取该视频。</li>
              <li>原视频、画面识别结果、蒙版数据和导出视频只在设备本地处理，不会上传到我们的服务器。</li>
          ...
          <section>
            <h2>2. 本地内容与使用责任</h2>
            <p>镜隐的本地版不会把视频提交到服务器，也不会查看或审核设备上的视频内容。你可以使用遮盖、像素化、变音和静音等功能处理自己有权使用的素材。</p>
            <p>本地处理不代表任何发布行为都合法。你应确保拥有素材及其中人物的必要授权，并遵守所在地法律、隐私义务和发布平台规则。不得使用镜隐制作、传播违法内容，或侵犯他人的肖像权、隐私权、名誉权和知识产权。</p>
            <p>镜隐不提供社区、公开作品库、云端分享或代用户发布视频。若未来增加云端处理、同步或内容分享功能，会在上线前更新本政策。</p>
          </section>

          <section>
            <h2>3. 照片、文件与权限</h2>
            <p>照片图库和文件权限只用于导入你选择的视频，以及按你的操作保存或分享处理结果。你可以在 iOS“设置”中更改相关权限。</p>
          </section>
          ...
          <section>
            <h2>5. 网页版与网站访问数据</h2>
            <p>网页版同样在浏览器本地处理视频。为运行识别功能，浏览器可能下载并缓存模型文件，但视频内容不会随之上传。</p>
            <p>
