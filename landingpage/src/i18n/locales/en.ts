...
export const landingEn: LandingCopy = {
  ...
  features: [
    ...
    {
      title: 'Photo batch',
      body: 'Multi-select photos, apply shared settings, review masks one by one. Lifetime unlocks batch export.',
    },
    {
      title: 'Audio privacy',
      body: 'Keep original audio, export silently, or shift pitch offline to protect voices nearby.',
    },
    {
      title: 'Strip metadata',
      body: 'Remove location, device, and capture-time metadata on export to reduce accidental leaks.',
    },
  ],
  stepsTitle: 'Three steps',
  stepsLead: 'Pick media, adjust covers, export to Photos or Share Sheet.',
  steps: [
    { title: 'Import', body: 'Choose a video from Photos or Files; multi-select photos.' },
    { title: 'Cover', body: 'Auto detection plus manual masks—preview matches export.' },
    { title: 'Export', body: 'Save to Photos or send through the system share sheet.' },
  ],
  ...
  freePoints: [
    'Video export: first 30s, up to 720p',
    'Photos: 1 image per export',
    'No watermark, no ads',
  ],
