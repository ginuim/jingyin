...
| --- | --- | --- |
| 美国（基准） | `$4.99` | 所在国家或地区 |
| 中国大陆 | `¥28` | 手动覆盖；不再随汇率自动调 |
| 其他地区 | Apple 自动换算 | 约 174 个国家或地区可自动调整 |

### 本地化

| 语言 | 显示名称 | 描述 |
| --- | --- | --- |
| 简体中文 | 永久版 | 一次购买，永久解锁完整视频隐私处理 |
| 繁体中文 | 永久版 | 一次購買，永久解鎖完整影片隱私處理 |
| 英语（美国） | Lifetime Access | One-time purchase for full video privacy exports |
| 日语 | 永久版 | 一度の購入で動画プライバシー処理を完全解放 |
