...
- 支持 URL：`https://reaidea.com`（提交前再次确认页面可访问且联系入口清晰）
...
视频和照片全程本地处理：像素化、模糊、手动遮盖、照片批量与变音，无需上传原素材。

### 描述

镜隐是一款端侧视频与照片隐私处理工具。原素材、识别数据和导出结果都在你的设备上处理，
无需上传服务器。
...
• 保留原声、静音导出或改变音高  
• 导出时清除位置、设备和拍摄时间等来源元数据  
• 保存到相册或通过系统分享面板发送

免费版可以完整编辑和预览：视频导出前 30 秒、最高 720p、无水印；照片每次导出 1 张。
一次买断永久版后可解除视频时长与分辨率限制，并解锁照片批量导出。没有订阅，也没有广告。

首个版本专注于可靠处理短视频与照片批处理，视频支持最长 5 分钟、最大 1 GB。

### 关键词（87 字节）

视频隐私,照片打码,批量打码,像素化,人脸遮盖,声音变调,本地处理
...
一次買斷永久版後可解除影片時長與解析度限制，並解鎖照片批次匯出。沒有訂閱，也沒有廣告。
...
one-time Lifetime Access purchase unlocks full video exports and batch photo exports. There
are no subscriptions and no ads.
...
書き出しも利用できます。サブスクリプションも広告もありません。
